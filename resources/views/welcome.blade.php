...
<head>
		...
		<!--== CSS Files ==-->
		<link href="storage/front/css/bootstrap.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/style.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/font-awesome.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/owl.carousel.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/flexslider.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/fancySelect.css" rel="stylesheet" media="screen">
		<link href="storage/front/css/responsive.css" rel="stylesheet" media="screen">
	...
	<body>
		<header id="header">
						...
						<nav role="navigation" class="col-sm-12">
							...
							<div class="navbar-collapse collapse">
								...
								<ul class="nav navbar-nav">
									...
									<li><a href="#prices">Reservation</a></li>
			...
			<div class="header-bg">
				...
				<div class="main-slider" id="main-slider">
					...
					<!--== Main Slider ==-->
					<ul class="slides">
						<li><img src="storage/front/images/demo/bg-slide-01.jpg" alt="Slide Image"/></li>
						<li><img src="storage/front/images/demo/bg-slide-02.jpg" alt="Slide Image 2"/></li>
					</ul>
		...
		<section id="about" class="about-us">
			...
			<div class="col-md-4">
				...
				<br />
					...
					<ul class="timeline" style="width: 200%">
					    ...
					    <li>
					        ...
					        <div class="timeline-panel">
					            <div class="timeline-heading">
					                <h4>{{$event->cat_name}}</h4>
					            </div>
					            <div class="timeline-body">
					                <p class="timeline-desc col-md-6">{{$event->cat_des}}</p>
					                <p class="timeline-other col-md-6">
					                	
					                	<em class="timeline-item">
					                	 Venue : {{$event->cat_venue}}
					                	</em> 
					                	<em class="timeline-item">
					                	Seats : {{$event->cat_seat}}
					                	</em>
					                	<em class="timeline-item">
					                	Ticket: ${{$event->cat_ticket}} 
					                	</em>
				...
				<section id="prices" class="row">
                    <div class="container">
                        ...
                        <form action="{{route('reserve.form')}}" method="post">
							...
							<div class="form-group">
                                <label for="guests">Event Name:</label>
                ...
                <div class="row">
                    ...
                    <div id="testimonial-container" class="col-xs-12">
                        <div class="testimonila-block">
                            <img src="storage/front/images/testimonial.jpg" alt="clients" class="selfshot">
                        ...
                        <div class="testimonila-block">
                            <img src="storage/front/images/testimonial2.jpg" alt="clients" class="selfshot">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem sed mollitia illum! Molestiae dignissimos, hic dolorem et eius ut nobis. Corrupti totam amet aperiam aut voluptate nobis dolor at soluta.</p>
                        ...
                        <div class="testimonila-block">
                            <img src="storage/front/images/testimonial3.jpg" alt="clients" class="selfshot">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem sed mollitia illum! Molestiae dignissimos, hic dolorem et eius ut nobis. Corrupti totam amet aperiam aut voluptate nobis dolor at soluta.</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <form role="form" method="POST" action="{{route('contract.us')}}">
								@csrf
                              <div class="form-group">
                                <input type="text" class="form-control" id="user_name" name="name" placeholder="Enter your name">
                              </div>
                              <div class="form-group">
                                <input type="email" class="form-control" id="your_email" name="email" placeholder="Enter your email">
                              </div>
                              <div class="form-group">
		...
		<script src="storage/front/js/jquery-2.1.0.min.js"></script>
		<script src="storage/front/js/bootstrap.min.js"></script>
		<script src="storage/front/js/jquery.scrollTo.js"></script>
		<script src="storage/front/js/jquery.nav.js"></script>
		<script src="storage/front/js/jquery.flexslider.js"></script>
		<script src="storage/front/js/jquery.accordion.js"></script>
		<script src="storage/front/js/jquery.placeholder.js"></script>
		<script src="storage/front/js/jquery.fitvids.js"></script>
		<script src="storage/front/js/gmap3.js"></script>
		<script src="storage/front/js/fancySelect.js"></script>
		<script src="storage/front/js/owl.carousel.min.js"></script>
